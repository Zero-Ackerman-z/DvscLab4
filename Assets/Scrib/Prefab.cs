...
public class Prefab : MonoBehaviour
{
    ...
    {
        if (sizeRatio > 0.75f) return 300; // Puntaje máximo si el tamaño está cerca del inicial
        if (sizeRatio > 0.5f) return 100;  // Puntaje medio si el tamaño está a la mitad
        return 50;                         // Puntaje mínimo si el tamaño está en el mínimo
    }
}
